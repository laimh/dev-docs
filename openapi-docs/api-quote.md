...
<tbody>
	...
	<tr>
		...
		<td>json(map)</td>
		<td>是</td>
		<td>POST 方法提交的流数据，字段与值的键值对，例如 <code>{ "quoteName":"京东尚科500用户版" }</code><br>字段可通过 <a href="api-metadata.html">元数据</a> 接口获取</td>
	</tr>
</tbody>
</table>
...
<tbody>
	<tr>
		<td>quote_id</td>
		<td>string(40)</td>
		<td>新增报价的唯一ID，为 40 位 hash 字符串</td>
	</tr>
</tbody>
</table>
...
<pre>
{
  ...
  "error_msg": "调用成功",
  "data": {
    "quoteName": "京东尚科500用户版",
    "quoteDate": "2017-02-01"
  }
}
</pre>
...
<tbody>
	...
	<tr>
		...
		<td>string</td>
		<td>否</td>
		<td>查询主显字段（name_field），支持使用星号模糊匹配，如 <code>*500用户</code> 将查询以企能软件结尾的报价。如需更复杂的查询请参考 <a href="api-advquery.html">高级查询接口</a></td>
	</tr>
    <tr>
		<td>page_no</td>
		<td>int</td>
...
<pre>
{
  ...
  "page_no": 1,
  "data": [
    { "quoteId": "xxx", "quoteName": "京东尚科500用户版", "quoteDate": "2017-02-01" },
    { "quoteId": "xxx", "quoteName": "京东尚科500用户版", "quoteDate": "2017-02-01" }
  ]
}
</pre>
...
<tbody>
	...
	<tr>
		...
		<td>json(map)</td>
		<td>是</td>
		<td>POST 方法提交的流数据，字段与值的键值对，例如 <code>{ "quoteName":"京东尚科500用户版" }</code><br>字段请通过 <a href="api-metadata.html">元数据</a> 接口获取</td>
	</tr>
</tbody>
</table>
